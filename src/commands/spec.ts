...
const SPECS_DIR = 'infraspec/specs';
...
export class SpecCommand {
  private SPECS_DIR = 'infraspec/specs';
  ...
  async show(specId?: string, options: ShowOptions = {}): Promise<void> {
    ...
    if (!existsSync(specPath)) {
      throw new Error(`Spec '${specId}' not found at infraspec/specs/${specId}/spec.md`);
    }
...
export function registerSpecCommand(rootProgram: typeof program) {
  const specCommand = rootProgram
    .command('spec')
    .description('Manage and view InfraSpec specifications');

  // Deprecation notice for noun-based commands
  specCommand.hook('preAction', () => {
    console.error('Warning: The "infraspec spec ..." commands are deprecated. Prefer verb-first commands (e.g., "infraspec show", "infraspec validate --specs").');
  });
