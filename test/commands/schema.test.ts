...
describe('schema command', () => {
  ...
  beforeEach(() => {
    ...
    fs.mkdirSync(path.join(tempDir, 'infraspec', 'schemas'), { recursive: true });
  ...
  describe('schema which', () => {
    ...
    it('should detect project schema shadowing package', async () => {
      ...
      const projectSchemaDir = path.join(tempDir, 'infraspec', 'schemas', 'spec-driven');
...
`
  ...
  describe('schema validate', () => {
    it('should validate a valid schema', async () => {
      ...
      const schemaDir = path.join(tempDir, 'infraspec', 'schemas', 'test-schema');
...
`
    ...
    it('should detect missing template file', async () => {
      const schemaDir = path.join(tempDir, 'infraspec', 'schemas', 'bad-schema');
      fs.mkdirSync(schemaDir, { recursive: true });
      fs.writeFileSync(
        path.join(schemaDir, 'schema.yaml'),
        `name: bad-schema
...
`;
  ...
  describe('schema fork', () => {
    it('should copy schema to project directory', async () => {
      ...
      const destDir = path.join(tempDir, 'infraspec', 'schemas', 'my-custom');
  ...
  describe('schema init', () => {
    it('should create schema directory with schema.yaml', async () => {
      const schemaDir = path.join(tempDir, 'infraspec', 'schemas', 'new-schema');
      fs.mkdirSync(schemaDir, { recursive: true });
