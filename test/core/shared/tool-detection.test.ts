...
describe('tool-detection', () => {
  ...
  describe('SKILL_NAMES', () => {
    it('should contain all skill names matching COMMAND_IDS', () => {
      ...
      expect(SKILL_NAMES).toContain('infra-archive-change');
      expect(SKILL_NAMES).toContain('infra-bulk-archive-change');
      expect(SKILL_NAMES).toContain('infra-verify-change');
      expect(SKILL_NAMES).toContain('infra-onboard');
      expect(SKILL_NAMES).toContain('infra-propose');
    });
  });
  ...
  describe('getToolSkillStatus', () => {
    ...
    it('should detect when one skill exists', async () => {
      const skillDir = path.join(testDir, '.claude', 'skills', 'infra-explore');
