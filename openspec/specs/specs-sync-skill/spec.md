...
- **THEN** the agent reads delta specs from `infraspec/changes/<name>/specs/`
- **AND** reads corresponding main specs from `infraspec/specs/`
...
- **THEN** create new main spec file at `infraspec/specs/<capability>/spec.md`
